import { Clock, ExternalLinkCursor, LogoText } from "@/components/elements";
...
const useStyles = createStyles(
	(theme, { initialism }: { initialism: boolean }) => ({
		header: {
			position: "fixed",
			top: 0,
			color: "#333333",
		...
		<header className={classes.header}>
            ...
            `}
					...
					>
						...
						>
							{opened && isActive && (
								<Panels setPanelComplete={setPanelComplete} />
							)}
						</AnimatePresence>
					</Box>
				</div>
